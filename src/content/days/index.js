...
export const DAY_REGISTRY = [
  ...
  // Bonus scene, not part of the dated 15-day trip sequence — unlocks at its own fixed
  // moment (see schedule.js's FIXED_UNLOCKS) rather than following TRIP_START_DATE.
